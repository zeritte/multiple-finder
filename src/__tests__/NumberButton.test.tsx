...
describe("Test NumberButton component", () => {
  it("SHOULD render the given number", () => {
    const number = 1;
    render(<NumberButton number={number} isSelected={false} isInMultiples={false} onClick={() => {}} />);
  ...
  it("SHOULD render the given number when selected", () => {
    const number = 123;
    render(<NumberButton number={number} isSelected={true} isInMultiples={false} onClick={() => {}} />);
    const numberButton = screen.getByTestId(`select-number-${number}`);
    expect(numberButton).toBeInTheDocument();
    expect(numberButton).toHaveTextContent(number.toString())
  ...
  it("SHOULD render the given number when in multiples", () => {
    const number = 123;
    render(<NumberButton number={number} isSelected={false} isInMultiples={true} onClick={() => {}} />);
    const numberButton = screen.getByTestId(`select-number-${number}`);
    expect(numberButton).toBeInTheDocument();
    expect(numberButton).toHaveTextContent(number.toString())
  ...
  it("SHOULD fire the onClick function on button press", () => {
    ...
    render(<NumberButton number={number} isSelected={false} isInMultiples={false} onClick={mockOnClick} />);
    const numberButton = screen.getByTestId(`select-number-${number}`);
    expect(numberButton).toBeInTheDocument();
    expect(numberButton).toHaveTextContent(number.toString())
